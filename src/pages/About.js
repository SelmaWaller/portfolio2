      ...
      <div className="content">
        ...
        <div className="aboutMe">
          <p>
            ...
            best way to describe is like a city of canadians to the rest of the
          ...
          <p>
            So how did I go from working on becoming a car mechanic (amongst
            other things) to suddenly fall so hard for programming? I was in the
            middle of a Portal 2 puzzle when it hit me that people actually make
            these games for a living. Thinking I should probably start with
            something easier than math equations consisting of close to zero
            digits, I paused the game and sent my application to the school I’m
            now soon to be graduating from.
          </p>
          <p>
